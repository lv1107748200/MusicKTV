package com.hr.mylibrary.utils;
...
public class GSYVideoType {
    ...
    public static void setRATION(int type){

        if(type == 0){
            //元比例填充
            setShowType(SCREEN_TYPE_DEFAULT);
        }else if(type == 1){
            setShowType(SCREEN_TYPE_16_9);
        }else if(type == 2){
            setShowType(SCREEN_TYPE_4_3);
        }else if(type == 3){
            setShowType(SCREEN_MATCH_FULL);
        }
